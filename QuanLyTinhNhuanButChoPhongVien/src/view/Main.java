...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        fKBV = "src/controller/KBV.dat"; 
        String[] pv = {"Ma PV", "Ho Ten", "Dia Chi", "Loai PV"};
        String[] kbv = {"Ma KB", "Ten KB", "Don Gia"};       
        tmPV = new DefaultTableModel(pv, 0); 
        tmKBV = new DefaultTableModel(kbv, 0);                        
        jTable1.setModel(tmPV);
        jTable2.setModel(tmKBV);           
        loadPV();
        showPV(listPV);
        loadKBV();
        showKBV(listKBV);
...
//        showBSX(listBSX);
    ...
    public void showPV(List<PhongVien> list){
        tmPV.setRowCount(0);
    ...
    public void loadKBV(){
        File f = new File(fKBV);
        if(f.exists()){
            listKBV = IOFile.doc(fKBV);
        }else{
            listKBV = new ArrayList<>();
        }
    }
    
    public void showKBV(List<KieuBV> list){
        tmKBV.setRowCount(0);
        for(KieuBV i : list){
            tmKBV.addRow(i.toObjects());
        }
    }
...
//    }
//    
//    private PhongVien getOToByMa(int ma){
//        for(PhongVien i : listOTo){
//            if(i.getMa() == ma){
//                return i;
//            }
...
//    }
    ...
    private boolean isEqualToInteger(int gia, String key) {
        try {
            return gia == Integer.parseInt(key);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Thong Tin Phong Vien", p1);
        ...
        jLabel5.setText("Ma KBV:");

        jTextField4.setEditable(false);

        jLabel7.setText("Ten KBV:");
        ...
        jRadioButton3.setText("Ten Kieu Bai Viet");
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Lua Chon Sap Xep--", "Ten Kieu Bai Viet", "Don Gia" }));
        ...
        jTabbedPane1.addTab("Thong Tin Kieu Bai Viet", p2);
        ...
        jLabel6.setText("Ma PV:");

        jLabel9.setText("Ma KBV:");
        ...
        jTabbedPane1.addTab("Thong Tin Bang Tinh Cong", p3);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        try {
            ...
            PhongVien pv = new PhongVien(ht, dc, loai);
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(r >= 0 && r < jTable1.getRowCount()){
            ...
            tmPV.setValueAt(ht, r, 1);
            tmPV.setValueAt(dc, r, 2);
            tmPV.setValueAt(loai, r, 3);
            int ma = Integer.parseInt(jTextField1.getText());
            PhongVien pv = new PhongVien(ma, ht, dc, loai);
            listPV.set(r, pv);
        }else{
            JOptionPane.showMessageDialog(this, "Chon Phong Vien De Sua");
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
        int r = jTable1.getSelectedRow();
        jComboBox1.setSelectedItem(tmPV.getValueAt(r, 3));
        jTextField1.setText(tmPV.getValueAt(r, 0).toString());
        jTextField2.setText(tmPV.getValueAt(r, 1).toString());
        jTextField3.setText(tmPV.getValueAt(r, 2).toString());
    }//GEN-LAST:event_jTable1MouseClicked

    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        // TODO add your handling code here:
        int r = jTable2.getSelectedRow();
        jTextField4.setText(tmKBV.getValueAt(r, 0).toString());
        jTextField5.setText(tmKBV.getValueAt(r, 1).toString());
        jTextField6.setText(tmKBV.getValueAt(r, 2).toString());
    ...
    private void btThem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThem1ActionPerformed
        ...
        int n = listKBV.size();
        if(n > 0){
            KieuBV.setSma(listKBV.get(n - 1).getMa() + 1);
        }
        jTextField4.setText(KieuBV.getSma() + "");
        String tenkb;
        int gia;
        try {
            tenkb = jTextField5.getText();
            gia = Integer.parseInt(jTextField6.getText());
            KieuBV kbv = new KieuBV(tenkb, gia);
            tmKBV.addRow(kbv.toObjects());
            listKBV.add(kbv);
        } catch (NumberFormatException e) {
    ...
    private void btSua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSua1ActionPerformed
        ...
        if(r >= 0 && r < jTable2.getRowCount()){
            ...
            int gia = Integer.parseInt(jTextField6.getText());
            tmKBV.setValueAt(ten, r, 1);
            tmKBV.setValueAt(gia, r, 2);
            int ma = Integer.parseInt(jTextField4.getText());
            KieuBV kbv = new KieuBV(ma, ten, gia);
            listKBV.set(r, kbv);
        }else{
...
//        showBSX(listBSX);
    ...
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        ...
        if(jRadioButton3.isSelected()){
            listKBV.sort(new Comparator<KieuBV>(){
                @Override
                public int compare(KieuBV o1, KieuBV o2) {
                    String[] ht1 = o1.getTen().split("\\s+");
                    String[] ht2 = o2.getTen().split("\\s+");
                    String ten1 = ht1[ht1.length - 1];
                    String ten2 = ht2[ht2.length - 1];
                    if(ten1.equalsIgnoreCase(ten2)){
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        List<KieuBV> tim = new ArrayList<>();
        String key = jTextField9.getText().trim().toLowerCase();
        for(KieuBV i : listKBV){
