...
public class Main extends javax.swing.JFrame {
    ...
    DefaultTableModel tmP, tmKH, tmBSX;
    String fP, fKH, fBSX;
    List<Phong> listP;
    ...
    public Main() {
        ...
        fP = "src/controller/PH.dat"; 
        fKH = "src/controller/KH.dat"; 
        fBSX = "src/controller/QLBH.dat";         
        String[] p = {"Ma Phong", "Kieu Phong", "Tien Thue", "So Phong"};
        String[] kh = {"Ma KH", "Ten KH", "Loai Phong", "So Phong Thue"};       
        String[] bsx = {"Ma Phong", "Kieu Phong", "Ma KH", "Ten KH", "So Luong Phong", "Ngay Ban"};
    ...
    public void showP(List<Phong> list){
        tmP.setRowCount(0);
        for(Phong i : list){
...
//    
    ...
    private void initComponents() {
        ...
        jRadioButton3.setText("Ho Ten KH");
        ...
        jRadioButton4.setText("So Phong Thue");
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Lua Chon Sap Xep--", "Ho Va Ten Khach Hang", "So Phong Thue" }));
        ...
        jLabel13.setText("So Phong Thue:");
        ...
        jLabel10.setText("So Luong Phong:");
        ...
        jRadioButton1.setText("Ho Ten KH");
        ...
        jRadioButton2.setText("Ngay Thue");
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Lua Chon Sap Xep--", "Ho Va Ten KH", "Ngay Thue" }));
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        int tient, slp;
        try {
            kieup = jComboBox1.getSelectedItem().toString();
            tient = Integer.parseInt(jTextField2.getText());
            slp = Integer.parseInt(jTextField3.getText());
            Phong p = new Phong(kieup, tient, slp);
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        int r = jTable1.getSelectedRow();
        if(r >= 0 && r < jTable1.getRowCount()){
            String kieup = jComboBox1.getSelectedItem().toString();
            int tient = Integer.parseInt(jTextField2.getText());
            int slp = Integer.parseInt(jTextField3.getText());
            tmP.setValueAt(kieup, r, 1);
            tmP.setValueAt(tient, r, 2);
            tmP.setValueAt(slp, r, 3);
            int ma = Integer.parseInt(jTextField1.getText());
            Phong p = new Phong(ma, kieup, tient, slp);
            listP.set(r, p);
        }else{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
        int r = jTable1.getSelectedRow();
        jTextField1.setText(tmP.getValueAt(r, 0).toString());
        jComboBox1.setSelectedItem(tmP.getValueAt(r, 1));
        jTextField2.setText(tmP.getValueAt(r, 2).toString());
        jTextField3.setText(tmP.getValueAt(r, 3).toString());
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        jTextField10.setText(tmKH.getValueAt(r, 3).toString());        
    ...
    private void btThem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThem1ActionPerformed
        ...
        try {
            ...
            loaip = jTextField6.getText();
            sopt = Integer.parseInt(jTextField10.getText());
            KhachHang kh = new KhachHang(ht, loaip, sopt);
    ...
    private void btSua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSua1ActionPerformed
        ...
        int r = jTable2.getSelectedRow();
        if(r >= 0 && r < jTable2.getRowCount()){
            String ht = jTextField5.getText();
            String loaip = jTextField6.getText();
            int sopt = Integer.parseInt(jTextField10.getText());
            tmKH.setValueAt(ht, r, 1);
            tmKH.setValueAt( loaip, r, 2);
            tmKH.setValueAt(sopt, r, 3);
            int ma = Integer.parseInt(jTextField4.getText());
            KhachHang kh = new KhachHang(ma, ht, loaip, sopt);
            listKH.set(r, kh);
        }else{
            JOptionPane.showMessageDialog(this, "Chon Dich Vu De Sua");
        }
    ...
    private void btThem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThem2ActionPerformed
        ...
        try {
            ngayt = jTextField8.getText();
            sl = Integer.parseInt(jTextField7.getText());
            if(sl > slp){
                JOptionPane.showMessageDialog(this, "Khong Du Phong Chon Phong Khac");
                jTextField1.requestFocus();
                return;
            }
            BangSX bsx = new BangSX(getPhongByMa(map), getKhachHangByMa(makh), ngayt, sl);
            tmBSX.addRow(bsx.toObjects());
            listBSX.add(bsx);
            getPhongByMa(map).setSlp(slp - sl);
            IOFile.viet(fP, listP);
        } catch (NumberFormatException e) {
    ...
    private void btSua2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSua2ActionPerformed
        ...
        int r = jTable3.getSelectedRow();
        if(r >= 0 && r < jTable3.getRowCount()){
            String ngayt = jTextField8.getText();
            int sl = Integer.parseInt(jTextField7.getText());
            tmBSX.setValueAt(ngayt, r, 5);
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        if(jRadioButton2.isSelected()){
            listBSX.sort(new Comparator<BangSX>(){
                @Override
                public int compare(BangSX o1, BangSX o2) {
                    return o1.getNgayt().compareTo(o2.getNgayt());
                }
            });
        }
        showBSX(listBSX);
    ...
    private void jRadioButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton4ActionPerformed
        ...
        if(jRadioButton4.isSelected()){
            listKH.sort(new Comparator<KhachHang>(){
                @Override
                public int compare(KhachHang o1, KhachHang o2) {
                    return Integer.compare(o1.getSopt(), o2.getSopt());
                }
            });
        }
        showKH(listKH);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        List<Phong> tim = new ArrayList<>();
        String key = jTextField11.getText().trim().toLowerCase();
        for(Phong i : listP){
            if(i.getKieup().toLowerCase().contains(key) || String.valueOf(i.getSlp()).contains(key)){
                tim.add(i);
            }
        }
        showP(tim);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        List<BangSX> tim = new ArrayList<>();
        String key = jTextField12.getText().trim().toLowerCase();
        for(BangSX i : listBSX){
            if(i.getKh().getHt().toLowerCase().contains(key) || i.getNgayt().contains(key)){
                tim.add(i);
            }
        }
        showBSX(tim);
